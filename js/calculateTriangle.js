document.getElementById('triangleBtn').addEventListener('click',function(){
    ...
    li.innerText = 'Triangle';
    li.style.marginTop='10px';
    button.innerText='Remove';
    button.classList.add("btn");
    button.classList.add("btn-info");
    button.style.marginLeft='10px';
    button.setAttribute('id','convertBtn1');
    ...
    document.getElementById('triangle1').value='';
    document.getElementById('triangle2').value='';
